...
PARAM$experimento <- "BO_Mod06_fhistv2pca"

PARAM$input$dataset <- "./datasets/competencia03_FEhist_v2_reduced_pca.csv.gz"
...
campos_buenos <- setdiff(
  colnames(dataset),
  c("clase_ternaria", "clase01", "azar", "training", "clase_gral_n", "clase_gral","add_mesn","add_last_mes","add_lastn"))
)
